...
<body>
	<form action="add" method="post">
		...
		Employee Name&nbsp;&nbsp;<input type="text" name="name"
					required="required" /><br>
		Gender&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					type="text" name="gender" required="required" /><br>
		Age&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					type="number" name="age" required="required" /><br> 
		Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					type="email" name="email" required="required" /><br> 
		Salary&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					type="number" name="salary" required="required" /> <br>
		Designation&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"
					name="designation" required="required" /><br> 
